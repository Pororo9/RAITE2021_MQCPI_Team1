...
<div class='row'>
      <div class='col-md-6'>
        <div class='form-group'>
          <label for='In_Case_LastName'>Last Name</label>
          <input type='text' class='form-control' id='In_Case_LastName' placeholder='Enter Last Name' name='In_Case_LastName' required>                  
        </div>                
        <!-- /.form-group -->
      </div>
      <!-- /.col -->
      <div class='col-md-6'>
        <div class='form-group'>
        <label for='In_Case_FirstName'>First Name</label>
        <input type='text' class='form-control' id='In_Case_FirstName' placeholder='Enter First Name' name='In_Case_FirstName' required>         
        </div>
        <!-- /.form-group -->             
      </div>
      <!-- /.col -->            
    ...
    <div class='col-md-6'>
      <div class='form-group'>
        <label for='In_Case_MiddleName'>Middle Name</label>
        <input type='text' class='form-control' id='In_Case_MiddleName' placeholder='Enter Middle Name' name='In_Case_MiddleName' required>                  
      </div>                
      <!-- /.form-group -->
    </div>
    <!-- /.col -->
